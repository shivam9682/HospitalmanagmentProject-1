        ...
        try {
            ...
            String htmlContent = """
                ...
                <style>
                    ...
                    .container { max-width:600px; margin:auto; background:#ffffff; border-radius:10px; padding:25px; }
                    h2 { color:#2c3e50; text-align:center; font-size:24px; }
                    p { font-size:16px; color:#555; line-height:1.6; }
                    .btn { display:inline-block; background:#28a745; color:#ffffff !important; padding:14px 30px; text-decoration:none; border-radius:6px; font-size:16px; margin:20px auto; }
                ...
                <body>
                    <div style="padding:20px;">
                        <div class="container">
                            <h2>Welcome, {{name}} 👋</h2>
                            <p><b>Your registration was successful.</b><br>We’re excited to have you with us!</p>
                            <div style="text-align:center;">
                                <a href="http://localhost:8080/log" class="btn">Login to Your Account</a>
                            </div>
                            <p style="font-size:14px; color:#777;">If you didn’t create this account, please ignore this email.</p>
                            <hr>
